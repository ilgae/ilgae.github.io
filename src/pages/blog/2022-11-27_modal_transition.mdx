...
stack: 'React'
description: 'Nice Modal로 모달 띄우기. React Transition Group으로 애니메이션 추가하기. query-string을 이용해 url쿼리를 상태로 관리하기'
pubDate: 'Nov 27 2022'
...
-   [query-string](https://www.npmjs.com/package/query-string)
    ...
    기존 프로젝트에서 사용하고 있던 라이브러리<br/>url에 현재 상태를 표현하기 위해 query를 붙힐 때 사용하고 있다
